...
// GetDisableOutgoingIPv6 returns the DisableOutgoingIPv6 field value if set, zero value otherwise.
func (o *ServerConfiguration) GetDisableOutgoingIPv6() bool {
	if o == nil || IsNil(o.DisableOutgoingIPv6) {
		var ret bool
		return ret
	}
	return *o.DisableOutgoingIPv6
}

// GetDisableOutgoingIPv6Ok returns a tuple with the DisableOutgoingIPv6 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerConfiguration) GetDisableOutgoingIPv6Ok() (*bool, bool) {
	if o == nil || IsNil(o.DisableOutgoingIPv6) {
		return nil, false
	}
	return o.DisableOutgoingIPv6, true
}
...
// SetDisableOutgoingIPv6 gets a reference to the given bool and assigns it to the DisableOutgoingIPv6 field.
func (o *ServerConfiguration) SetDisableOutgoingIPv6(v bool) {
	o.DisableOutgoingIPv6 = &v
}
...
// GetLibraryMonitorDelaySeconds returns the LibraryMonitorDelaySeconds field value if set, zero value otherwise.
func (o *ServerConfiguration) GetLibraryMonitorDelaySeconds() int32 {
	if o == nil || IsNil(o.LibraryMonitorDelaySeconds) {
		var ret int32
		return ret
	}
	return *o.LibraryMonitorDelaySeconds
}

// GetLibraryMonitorDelaySecondsOk returns a tuple with the LibraryMonitorDelaySeconds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerConfiguration) GetLibraryMonitorDelaySecondsOk() (*int32, bool) {
	if o == nil || IsNil(o.LibraryMonitorDelaySeconds) {
		return nil, false
	}
	return o.LibraryMonitorDelaySeconds, true
}
...
// SetLibraryMonitorDelaySeconds gets a reference to the given int32 and assigns it to the LibraryMonitorDelaySeconds field.
func (o *ServerConfiguration) SetLibraryMonitorDelaySeconds(v int32) {
	o.LibraryMonitorDelaySeconds = &v
}
...
func (o *ServerConfiguration) GetPreferredDetectedRemoteAddressFamily() NetSocketsAddressFamily {
	if o == nil || IsNil(o.PreferredDetectedRemoteAddressFamily) {
		var ret NetSocketsAddressFamily
		return ret
	}
...
// SetPreferredDetectedRemoteAddressFamily gets a reference to the given NetSocketsAddressFamily and assigns it to the PreferredDetectedRemoteAddressFamily field.
...
// GetImageExtractorUpgraded1 returns the ImageExtractorUpgraded1 field value if set, zero value otherwise.
func (o *ServerConfiguration) GetImageExtractorUpgraded1() bool {
	if o == nil || IsNil(o.ImageExtractorUpgraded1) {
		var ret bool
		return ret
	}
	return *o.ImageExtractorUpgraded1
}

// GetImageExtractorUpgraded1Ok returns a tuple with the ImageExtractorUpgraded1 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerConfiguration) GetImageExtractorUpgraded1Ok() (*bool, bool) {
	if o == nil || IsNil(o.ImageExtractorUpgraded1) {
		return nil, false
	}
	return o.ImageExtractorUpgraded1, true
}
...
// SetImageExtractorUpgraded1 gets a reference to the given bool and assigns it to the ImageExtractorUpgraded1 field.
func (o *ServerConfiguration) SetImageExtractorUpgraded1(v bool) {
	o.ImageExtractorUpgraded1 = &v
}
...
// GetMaxLibraryDatabaseConnections returns the MaxLibraryDatabaseConnections field value if set, zero value otherwise.
func (o *ServerConfiguration) GetMaxLibraryDatabaseConnections() int32 {
	if o == nil || IsNil(o.MaxLibraryDatabaseConnections) {
		var ret int32
		return ret
	}
	return *o.MaxLibraryDatabaseConnections
}

// GetMaxLibraryDatabaseConnectionsOk returns a tuple with the MaxLibraryDatabaseConnections field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerConfiguration) GetMaxLibraryDatabaseConnectionsOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxLibraryDatabaseConnections) {
		return nil, false
	}
	return o.MaxLibraryDatabaseConnections, true
}
...
// SetMaxLibraryDatabaseConnections gets a reference to the given int32 and assigns it to the MaxLibraryDatabaseConnections field.
func (o *ServerConfiguration) SetMaxLibraryDatabaseConnections(v int32) {
	o.MaxLibraryDatabaseConnections = &v
}

// GetMaxAuthDbConnections returns the MaxAuthDbConnections field value if set, zero value otherwise.
func (o *ServerConfiguration) GetMaxAuthDbConnections() int32 {
	if o == nil || IsNil(o.MaxAuthDbConnections) {
		var ret int32
		return ret
	}
	return *o.MaxAuthDbConnections
}

// GetMaxAuthDbConnectionsOk returns a tuple with the MaxAuthDbConnections field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerConfiguration) GetMaxAuthDbConnectionsOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxAuthDbConnections) {
		return nil, false
	}
	return o.MaxAuthDbConnections, true
}
...
// SetMaxAuthDbConnections gets a reference to the given int32 and assigns it to the MaxAuthDbConnections field.
func (o *ServerConfiguration) SetMaxAuthDbConnections(v int32) {
	o.MaxAuthDbConnections = &v
}

// GetMaxOtherDbConnections returns the MaxOtherDbConnections field value if set, zero value otherwise.
func (o *ServerConfiguration) GetMaxOtherDbConnections() int32 {
	if o == nil || IsNil(o.MaxOtherDbConnections) {
		var ret int32
		return ret
	}
	return *o.MaxOtherDbConnections
}

// GetMaxOtherDbConnectionsOk returns a tuple with the MaxOtherDbConnections field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerConfiguration) GetMaxOtherDbConnectionsOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxOtherDbConnections) {
		return nil, false
	}
	return o.MaxOtherDbConnections, true
}
...
// SetMaxOtherDbConnections gets a reference to the given int32 and assigns it to the MaxOtherDbConnections field.
func (o *ServerConfiguration) SetMaxOtherDbConnections(v int32) {
	o.MaxOtherDbConnections = &v
}
...
// GetMigratedToUserItemShares8 returns the MigratedToUserItemShares8 field value if set, zero value otherwise.
func (o *ServerConfiguration) GetMigratedToUserItemShares8() bool {
	if o == nil || IsNil(o.MigratedToUserItemShares8) {
		var ret bool
		return ret
	}
	return *o.MigratedToUserItemShares8
}

// GetMigratedToUserItemShares8Ok returns a tuple with the MigratedToUserItemShares8 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerConfiguration) GetMigratedToUserItemShares8Ok() (*bool, bool) {
	if o == nil || IsNil(o.MigratedToUserItemShares8) {
		return nil, false
	}
	return o.MigratedToUserItemShares8, true
}
...
// SetMigratedToUserItemShares8 gets a reference to the given bool and assigns it to the MigratedToUserItemShares8 field.
func (o *ServerConfiguration) SetMigratedToUserItemShares8(v bool) {
	o.MigratedToUserItemShares8 = &v
}
...
// GetTvChannelsRefreshed returns the TvChannelsRefreshed field value if set, zero value otherwise.
func (o *ServerConfiguration) GetTvChannelsRefreshed() bool {
	if o == nil || IsNil(o.TvChannelsRefreshed) {
		var ret bool
		return ret
	}
	return *o.TvChannelsRefreshed
}

// GetTvChannelsRefreshedOk returns a tuple with the TvChannelsRefreshed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerConfiguration) GetTvChannelsRefreshedOk() (*bool, bool) {
	if o == nil || IsNil(o.TvChannelsRefreshed) {
		return nil, false
	}
	return o.TvChannelsRefreshed, true
}
...
// SetTvChannelsRefreshed gets a reference to the given bool and assigns it to the TvChannelsRefreshed field.
func (o *ServerConfiguration) SetTvChannelsRefreshed(v bool) {
	o.TvChannelsRefreshed = &v
}
...
// SetProxyHeaderMode gets a reference to the given ProxyHeaderMode and assigns it to the ProxyHeaderMode field.
...
// GetMaintenanceModeMessage returns the MaintenanceModeMessage field value if set, zero value otherwise.
func (o *ServerConfiguration) GetMaintenanceModeMessage() string {
	if o == nil || IsNil(o.MaintenanceModeMessage) {
		var ret string
		return ret
	}
	return *o.MaintenanceModeMessage
}

// GetMaintenanceModeMessageOk returns a tuple with the MaintenanceModeMessage field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerConfiguration) GetMaintenanceModeMessageOk() (*string, bool) {
	if o == nil || IsNil(o.MaintenanceModeMessage) {
		return nil, false
	}
	return o.MaintenanceModeMessage, true
}
...
// SetMaintenanceModeMessage gets a reference to the given string and assigns it to the MaintenanceModeMessage field.
func (o *ServerConfiguration) SetMaintenanceModeMessage(v string) {
	o.MaintenanceModeMessage = &v
}
...
func (o ServerConfiguration) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DisableOutgoingIPv6) {
		toSerialize["DisableOutgoingIPv6"] = o.DisableOutgoingIPv6
	}
	...
	if !IsNil(o.LibraryMonitorDelaySeconds) {
		toSerialize["LibraryMonitorDelaySeconds"] = o.LibraryMonitorDelaySeconds
	}
	...
	if !IsNil(o.ImageExtractorUpgraded1) {
		toSerialize["ImageExtractorUpgraded1"] = o.ImageExtractorUpgraded1
	}
	...
	if !IsNil(o.MaxLibraryDatabaseConnections) {
		toSerialize["MaxLibraryDatabaseConnections"] = o.MaxLibraryDatabaseConnections
	}
	if !IsNil(o.MaxAuthDbConnections) {
		toSerialize["MaxAuthDbConnections"] = o.MaxAuthDbConnections
	}
	if !IsNil(o.MaxOtherDbConnections) {
		toSerialize["MaxOtherDbConnections"] = o.MaxOtherDbConnections
	}
	if !IsNil(o.DisableAsyncIO) {
		toSerialize["DisableAsyncIO"] = o.DisableAsyncIO
	}
	if !IsNil(o.MigratedToUserItemShares8) {
		toSerialize["MigratedToUserItemShares8"] = o.MigratedToUserItemShares8
	}
	...
	if !IsNil(o.TvChannelsRefreshed) {
		toSerialize["TvChannelsRefreshed"] = o.TvChannelsRefreshed
	}
	...
	if !IsNil(o.MaintenanceModeMessage) {
		toSerialize["MaintenanceModeMessage"] = o.MaintenanceModeMessage
	}
