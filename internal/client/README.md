...
```go
import embyclient "github.com/Kamaroth92/terraform-provider-emby/client"
```
...
*BackupApiAPI* | [**GetBackuprestoreBackupinfo**](docs/BackupApiAPI.md#getbackuprestorebackupinfo) | **Get** /BackupRestore/BackupInfo | 
*BackupApiAPI* | [**PostBackuprestoreRestore**](docs/BackupApiAPI.md#postbackuprestorerestore) | **Post** /BackupRestore/Restore | 
*BackupApiAPI* | [**PostBackuprestoreRestoredata**](docs/BackupApiAPI.md#postbackuprestorerestoredata) | **Post** /BackupRestore/RestoreData | 
...
*ChapterApiEndpointAPI* | [**GetChapterApiGetChapters**](docs/ChapterApiEndpointAPI.md#getchapterapigetchapters) | **Get** /chapter_api/get_chapters | Get a list of items for type and filtered
*ChapterApiEndpointAPI* | [**GetChapterApiGetItemPath**](docs/ChapterApiEndpointAPI.md#getchapterapigetitempath) | **Get** /chapter_api/get_item_path | Get a list of items for type and filtered
*ChapterApiEndpointAPI* | [**GetChapterApiGetItems**](docs/ChapterApiEndpointAPI.md#getchapterapigetitems) | **Get** /chapter_api/get_items | Get a list of items for type and filtered
*ChapterApiEndpointAPI* | [**GetChapterApiGetSummary**](docs/ChapterApiEndpointAPI.md#getchapterapigetsummary) | **Get** /chapter_api/get_summary | Get a list of items for type and filtered
*ChapterApiEndpointAPI* | [**GetChapterApiUpdateChapters**](docs/ChapterApiEndpointAPI.md#getchapterapiupdatechapters) | **Get** /chapter_api/update_chapters | Updates chapters
...
*CodecParameterServiceAPI* | [**GetEncodingdiagnosticsCodecparameters**](docs/CodecParameterServiceAPI.md#getencodingdiagnosticscodecparameters) | **Get** /EncodingDiagnostics/CodecParameters | Gets the parameters for a specified codec.
...
*CodecParameterServiceAPI* | [**PostEncodingdiagnosticsCodecparameters**](docs/CodecParameterServiceAPI.md#postencodingdiagnosticscodecparameters) | **Post** /EncodingDiagnostics/CodecParameters | Updates the parameters for a specified codec.
...
*ContentServiceAPI* | [**GetUsersByUseridHomesections**](docs/ContentServiceAPI.md#getusersbyuseridhomesections) | **Get** /Users/{UserId}/HomeSections | 
*ContentServiceAPI* | [**GetUsersByUseridSectionsBySectionidItems**](docs/ContentServiceAPI.md#getusersbyuseridsectionsbysectioniditems) | **Get** /Users/{UserId}/Sections/{SectionId}/Items | 
*DetectApiEndpointAPI* | [**GetChapterApiCancelJob**](docs/DetectApiEndpointAPI.md#getchapterapicanceljob) | **Get** /chapter_api/cancel_job | Cancel a job
*DetectApiEndpointAPI* | [**GetChapterApiDownloadIntroData**](docs/DetectApiEndpointAPI.md#getchapterapidownloadintrodata) | **Get** /chapter_api/download_intro_data | Intro DB download
*DetectApiEndpointAPI* | [**GetChapterApiGetEpisodeList**](docs/DetectApiEndpointAPI.md#getchapterapigetepisodelist) | **Get** /chapter_api/get_episode_list | Get list of episodes
*DetectApiEndpointAPI* | [**GetChapterApiGetJobInfo**](docs/DetectApiEndpointAPI.md#getchapterapigetjobinfo) | **Get** /chapter_api/get_job_info | Get job info
*DetectApiEndpointAPI* | [**GetChapterApiGetJobItem**](docs/DetectApiEndpointAPI.md#getchapterapigetjobitem) | **Get** /chapter_api/get_job_item | Gets info for a job work item
*DetectApiEndpointAPI* | [**GetChapterApiGetJobList**](docs/DetectApiEndpointAPI.md#getchapterapigetjoblist) | **Get** /chapter_api/get_job_list | Get list of jobs
*DetectApiEndpointAPI* | [**GetChapterApiGetSeasonList**](docs/DetectApiEndpointAPI.md#getchapterapigetseasonlist) | **Get** /chapter_api/get_season_list | Get list of seasons
*DetectApiEndpointAPI* | [**GetChapterApiGetSeriesList**](docs/DetectApiEndpointAPI.md#getchapterapigetserieslist) | **Get** /chapter_api/get_series_list | Get list of series
*DetectApiEndpointAPI* | [**GetChapterApiInsertChapters**](docs/DetectApiEndpointAPI.md#getchapterapiinsertchapters) | **Get** /chapter_api/insert_chapters | Insert detected chapters
*DetectApiEndpointAPI* | [**GetChapterApiIntroDataStats**](docs/DetectApiEndpointAPI.md#getchapterapiintrodatastats) | **Get** /chapter_api/intro_data_stats | Intro DB stats
*DetectApiEndpointAPI* | [**GetChapterApiReloadIntroData**](docs/DetectApiEndpointAPI.md#getchapterapireloadintrodata) | **Get** /chapter_api/reload_intro_data | Reloads the intro DB form the data path
*DetectApiEndpointAPI* | [**GetChapterApiRemoveJob**](docs/DetectApiEndpointAPI.md#getchapterapiremovejob) | **Get** /chapter_api/remove_job | Remove a job
*DetectApiEndpointAPI* | [**PostChapterApiAddDetectionJob**](docs/DetectApiEndpointAPI.md#postchapterapiadddetectionjob) | **Post** /chapter_api/add_detection_job | Add detection job
...
*DiagnosticsPluginServiceAPI* | [**GetEncodingdiagnosticsDiagnosticoptions**](docs/DiagnosticsPluginServiceAPI.md#getencodingdiagnosticsdiagnosticoptions) | **Get** /EncodingDiagnostics/DiagnosticOptions | Gets the EncodingDiagnosticOptions for generic editor
*DiagnosticsPluginServiceAPI* | [**PostEncodingdiagnosticsDiagnosticoptions**](docs/DiagnosticsPluginServiceAPI.md#postencodingdiagnosticsdiagnosticoptions) | **Post** /EncodingDiagnostics/DiagnosticOptions | Updates EncodingDiagnosticOptions from generic editor
...
*DisplayPreferencesServiceAPI* | [**GetUsersettingsByUserid**](docs/DisplayPreferencesServiceAPI.md#getusersettingsbyuserid) | **Get** /UserSettings/{UserId} | Gets user settings
...
*DisplayPreferencesServiceAPI* | [**PostUsersettingsByUserid**](docs/DisplayPreferencesServiceAPI.md#postusersettingsbyuserid) | **Post** /UserSettings/{UserId} | Updates a user&#39;s display preferences for an item
*DisplayPreferencesServiceAPI* | [**PostUsersettingsByUseridPartial**](docs/DisplayPreferencesServiceAPI.md#postusersettingsbyuseridpartial) | **Post** /UserSettings/{UserId}/Partial | Updates a user&#39;s display preferences for an item
...
*DynamicHlsServiceAPI* | [**GetAudioByIdLiveM3u8**](docs/DynamicHlsServiceAPI.md#getaudiobyidlivem3u8) | **Get** /Audio/{Id}/live.m3u8 | 
...
*DynamicHlsServiceAPI* | [**GetVideosByIdLiveM3u8**](docs/DynamicHlsServiceAPI.md#getvideosbyidlivem3u8) | **Get** /Videos/{Id}/live.m3u8 | 
...
*ExtractApiEndpointAPI* | [**GetChapterApiExtractTheme**](docs/ExtractApiEndpointAPI.md#getchapterapiextracttheme) | **Get** /chapter_api/extract_theme | Extract the Theme chromaprint
...
*LiveStreamServiceAPI* | [**GetLivetvLiverecordingsByIdHlsBySegment**](docs/LiveStreamServiceAPI.md#getlivetvliverecordingsbyidhlsbysegment) | **Get** /LiveTv/LiveRecordings/{Id}/hls/{Segment} | Gets a live recording
*LiveStreamServiceAPI* | [**GetLivetvLiverecordingsByIdHlsLiveM3u8**](docs/LiveStreamServiceAPI.md#getlivetvliverecordingsbyidhlslivem3u8) | **Get** /LiveTv/LiveRecordings/{Id}/hls/live.m3u8 | Gets a live recording
*LiveStreamServiceAPI* | [**GetLivetvLiverecordingsByIdHlsMasterM3u8**](docs/LiveStreamServiceAPI.md#getlivetvliverecordingsbyidhlsmasterm3u8) | **Get** /LiveTv/LiveRecordings/{Id}/hls/master.m3u8 | Gets a live recording
*LiveStreamServiceAPI* | [**GetLivetvLiverecordingsByIdStream**](docs/LiveStreamServiceAPI.md#getlivetvliverecordingsbyidstream) | **Get** /LiveTv/LiveRecordings/{Id}/stream | Gets a live tv channel
*LiveStreamServiceAPI* | [**GetLivetvLivestreamfilesByIdHlsBySegment**](docs/LiveStreamServiceAPI.md#getlivetvlivestreamfilesbyidhlsbysegment) | **Get** /LiveTv/LiveStreamFiles/{Id}/hls/{Segment} | Gets a live tv channel
*LiveStreamServiceAPI* | [**GetLivetvLivestreamfilesByIdHlsLiveM3u8**](docs/LiveStreamServiceAPI.md#getlivetvlivestreamfilesbyidhlslivem3u8) | **Get** /LiveTv/LiveStreamFiles/{Id}/hls/live.m3u8 | Gets a live tv channel
*LiveStreamServiceAPI* | [**GetLivetvLivestreamfilesByIdHlsMasterM3u8**](docs/LiveStreamServiceAPI.md#getlivetvlivestreamfilesbyidhlsmasterm3u8) | **Get** /LiveTv/LiveStreamFiles/{Id}/hls/master.m3u8 | Gets a live tv channel
*LiveStreamServiceAPI* | [**GetLivetvLivestreamfilesByIdStreamByContainer**](docs/LiveStreamServiceAPI.md#getlivetvlivestreamfilesbyidstreambycontainer) | **Get** /LiveTv/LiveStreamFiles/{Id}/stream.{Container} | Gets a live tv channel
*LiveStreamServiceAPI* | [**HeadLivetvLiverecordingsByIdHlsBySegment**](docs/LiveStreamServiceAPI.md#headlivetvliverecordingsbyidhlsbysegment) | **Head** /LiveTv/LiveRecordings/{Id}/hls/{Segment} | Gets a live recording
*LiveStreamServiceAPI* | [**HeadLivetvLiverecordingsByIdHlsLiveM3u8**](docs/LiveStreamServiceAPI.md#headlivetvliverecordingsbyidhlslivem3u8) | **Head** /LiveTv/LiveRecordings/{Id}/hls/live.m3u8 | Gets a live recording
*LiveStreamServiceAPI* | [**HeadLivetvLiverecordingsByIdHlsMasterM3u8**](docs/LiveStreamServiceAPI.md#headlivetvliverecordingsbyidhlsmasterm3u8) | **Head** /LiveTv/LiveRecordings/{Id}/hls/master.m3u8 | Gets a live recording
*LiveStreamServiceAPI* | [**HeadLivetvLivestreamfilesByIdHlsBySegment**](docs/LiveStreamServiceAPI.md#headlivetvlivestreamfilesbyidhlsbysegment) | **Head** /LiveTv/LiveStreamFiles/{Id}/hls/{Segment} | Gets a live tv channel
*LiveStreamServiceAPI* | [**HeadLivetvLivestreamfilesByIdHlsLiveM3u8**](docs/LiveStreamServiceAPI.md#headlivetvlivestreamfilesbyidhlslivem3u8) | **Head** /LiveTv/LiveStreamFiles/{Id}/hls/live.m3u8 | Gets a live tv channel
*LiveStreamServiceAPI* | [**HeadLivetvLivestreamfilesByIdHlsMasterM3u8**](docs/LiveStreamServiceAPI.md#headlivetvlivestreamfilesbyidhlsmasterm3u8) | **Head** /LiveTv/LiveStreamFiles/{Id}/hls/master.m3u8 | Gets a live tv channel
...
*LiveTvServiceAPI* | [**GetLivetvTunersDiscover**](docs/LiveTvServiceAPI.md#getlivetvtunersdiscover) | **Get** /LiveTv/Tuners/Discover | 
...
*MediaInfoServiceAPI* | [**PostLivestreamsMediainfo**](docs/MediaInfoServiceAPI.md#postlivestreamsmediainfo) | **Post** /LiveStreams/MediaInfo | Gets media info for a live stream
...
*PartyServiceAPI* | [**GetParties**](docs/PartyServiceAPI.md#getparties) | **Get** /Parties | Gets a list of active parties
*PartyServiceAPI* | [**GetPartiesInfo**](docs/PartyServiceAPI.md#getpartiesinfo) | **Get** /Parties/Info | Gets info about the session&#39;s current party
*PartyServiceAPI* | [**PostParties**](docs/PartyServiceAPI.md#postparties) | **Post** /Parties | Creates a party
*PartyServiceAPI* | [**PostPartiesByIdJoin**](docs/PartyServiceAPI.md#postpartiesbyidjoin) | **Post** /Parties/{Id}/Join | Joins a party
*PartyServiceAPI* | [**PostPartiesLeave**](docs/PartyServiceAPI.md#postpartiesleave) | **Post** /Parties/Leave | Leaves a party
...
*SubtitleServiceAPI* | [**GetVideosByIdByMediasourceidAttachmentsByIndexStream**](docs/SubtitleServiceAPI.md#getvideosbyidbymediasourceidattachmentsbyindexstream) | **Get** /Videos/{Id}/{MediaSourceId}/Attachments/{Index}/Stream | Gets subtitles in a specified format.
...
*SubtitleServiceAPI* | [**HeadItemsByIdByMediasourceidSubtitlesByIndexByStartpositionticksStreamByFormat**](docs/SubtitleServiceAPI.md#headitemsbyidbymediasourceidsubtitlesbyindexbystartpositionticksstreambyformat) | **Head** /Items/{Id}/{MediaSourceId}/Subtitles/{Index}/{StartPositionTicks}/Stream.{Format} | Gets subtitles in a specified format.
*SubtitleServiceAPI* | [**HeadItemsByIdByMediasourceidSubtitlesByIndexStreamByFormat**](docs/SubtitleServiceAPI.md#headitemsbyidbymediasourceidsubtitlesbyindexstreambyformat) | **Head** /Items/{Id}/{MediaSourceId}/Subtitles/{Index}/Stream.{Format} | Gets subtitles in a specified format.
*SubtitleServiceAPI* | [**HeadVideosByIdByMediasourceidSubtitlesByIndexByStartpositionticksStreamByFormat**](docs/SubtitleServiceAPI.md#headvideosbyidbymediasourceidsubtitlesbyindexbystartpositionticksstreambyformat) | **Head** /Videos/{Id}/{MediaSourceId}/Subtitles/{Index}/{StartPositionTicks}/Stream.{Format} | Gets subtitles in a specified format.
*SubtitleServiceAPI* | [**HeadVideosByIdByMediasourceidSubtitlesByIndexStreamByFormat**](docs/SubtitleServiceAPI.md#headvideosbyidbymediasourceidsubtitlesbyindexstreambyformat) | **Head** /Videos/{Id}/{MediaSourceId}/Subtitles/{Index}/Stream.{Format} | Gets subtitles in a specified format.
...
*SyncServiceAPI* | [**HeadSyncJobitemsByIdFile**](docs/SyncServiceAPI.md#headsyncjobitemsbyidfile) | **Head** /Sync/JobItems/{Id}/File | Gets a sync job item file
...
*SystemServiceAPI* | [**HeadSystemPing**](docs/SystemServiceAPI.md#headsystemping) | **Head** /System/Ping | 
...
*TagServiceAPI* | [**PostItemsByIdTagsDelete**](docs/TagServiceAPI.md#postitemsbyidtagsdelete) | **Post** /Items/{Id}/Tags/Delete | Removes tags from an item
...
*UserLibraryServiceAPI* | [**PostItemsAccess**](docs/UserLibraryServiceAPI.md#postitemsaccess) | **Post** /Items/Access | Updates user item access
...
*UserLibraryServiceAPI* | [**PostItemsSharedLeave**](docs/UserLibraryServiceAPI.md#postitemssharedleave) | **Post** /Items/Shared/Leave | Leaves a shared item
...
*UserServiceAPI* | [**GetUsersItemaccess**](docs/UserServiceAPI.md#getusersitemaccess) | **Get** /Users/ItemAccess | Gets a list of users
...
## Documentation For Models
 ...
 - [ChapterApiAddDetectionJob](docs/ChapterApiAddDetectionJob.md)
