...
> PlaylistsAddToPlaylistInfo GetPlaylistsByIdAddtoplaylistinfo(ctx, id).Ids(ids).UserId(userId).Execute()
...
func main() {
	...
	// response from `GetPlaylistsByIdAddtoplaylistinfo`: PlaylistsAddToPlaylistInfo
...
> PlaylistsAddToPlaylistResult PostPlaylistsByIdItems(ctx, id).Ids(ids).UserId(userId).Execute()
...
func main() {
	...
	// response from `PostPlaylistsByIdItems`: PlaylistsAddToPlaylistResult
