...
type FfmpegOptionsServiceAPI interface {
	...
	*/
	...
	// GetEncodingFfmpegoptionsExecute executes the request
	...
	*/
	...
	// PostEncodingFfmpegoptionsExecute executes the request
	PostEncodingFfmpegoptionsExecute(r ApiPostEncodingFfmpegoptionsRequest) (*http.Response, error)
}
...
func (r ApiGetEncodingFfmpegoptionsRequest) Execute() (*EditObjectContainer, *http.Response, error) {
...
// Binary stream
func (r ApiPostEncodingFfmpegoptionsRequest) Body(body *os.File) ApiPostEncodingFfmpegoptionsRequest {
	r.body = body
	return r
}

func (r ApiPostEncodingFfmpegoptionsRequest) Execute() (*http.Response, error) {
