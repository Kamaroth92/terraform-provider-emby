...
// checks if the UserAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserAction{}
...
// SetType gets a reference to the given UserActionType and assigns it to the Type field.
...
func (o UserAction) ToMap() (map[string]interface{}, error) {
...
type NullableUserAction struct {
	value *UserAction
	isSet bool
}

func (v NullableUserAction) Get() *UserAction {
	return v.value
}

func (v *NullableUserAction) Set(val *UserAction) {
	v.value = val
	v.isSet = true
}

func (v NullableUserAction) IsSet() bool {
	return v.isSet
}

func (v *NullableUserAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserAction(val *UserAction) *NullableUserAction {
	return &NullableUserAction{value: val, isSet: true}
}

func (v NullableUserAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
