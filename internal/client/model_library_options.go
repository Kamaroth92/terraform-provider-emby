...
// GetCacheImages returns the CacheImages field value if set, zero value otherwise.
func (o *LibraryOptions) GetCacheImages() bool {
	if o == nil || IsNil(o.CacheImages) {
		var ret bool
		return ret
	}
	return *o.CacheImages
}

// GetCacheImagesOk returns a tuple with the CacheImages field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LibraryOptions) GetCacheImagesOk() (*bool, bool) {
	if o == nil || IsNil(o.CacheImages) {
		return nil, false
	}
	return o.CacheImages, true
}
...
// SetCacheImages gets a reference to the given bool and assigns it to the CacheImages field.
...
// GetEnablePlexIgnore returns the EnablePlexIgnore field value if set, zero value otherwise.
func (o *LibraryOptions) GetEnablePlexIgnore() bool {
	if o == nil || IsNil(o.EnablePlexIgnore) {
		var ret bool
		return ret
	}
	return *o.EnablePlexIgnore
}

// GetEnablePlexIgnoreOk returns a tuple with the EnablePlexIgnore field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LibraryOptions) GetEnablePlexIgnoreOk() (*bool, bool) {
	if o == nil || IsNil(o.EnablePlexIgnore) {
		return nil, false
	}
	return o.EnablePlexIgnore, true
}
...
// SetEnablePlexIgnore gets a reference to the given bool and assigns it to the EnablePlexIgnore field.
func (o *LibraryOptions) SetEnablePlexIgnore(v bool) {
	o.EnablePlexIgnore = &v
}
...
// GetMergeTopLevelFolders returns the MergeTopLevelFolders field value if set, zero value otherwise.
func (o *LibraryOptions) GetMergeTopLevelFolders() bool {
	if o == nil || IsNil(o.MergeTopLevelFolders) {
		var ret bool
		return ret
	}
	return *o.MergeTopLevelFolders
}

// GetMergeTopLevelFoldersOk returns a tuple with the MergeTopLevelFolders field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LibraryOptions) GetMergeTopLevelFoldersOk() (*bool, bool) {
	if o == nil || IsNil(o.MergeTopLevelFolders) {
		return nil, false
	}
	return o.MergeTopLevelFolders, true
}
...
// SetMergeTopLevelFolders gets a reference to the given bool and assigns it to the MergeTopLevelFolders field.
func (o *LibraryOptions) SetMergeTopLevelFolders(v bool) {
	o.MergeTopLevelFolders = &v
}

// GetAutoGenerateChapterIntervalMinutes returns the AutoGenerateChapterIntervalMinutes field value if set, zero value otherwise.
func (o *LibraryOptions) GetAutoGenerateChapterIntervalMinutes() int32 {
	if o == nil || IsNil(o.AutoGenerateChapterIntervalMinutes) {
		var ret int32
		return ret
	}
	return *o.AutoGenerateChapterIntervalMinutes
}

// GetAutoGenerateChapterIntervalMinutesOk returns a tuple with the AutoGenerateChapterIntervalMinutes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LibraryOptions) GetAutoGenerateChapterIntervalMinutesOk() (*int32, bool) {
	if o == nil || IsNil(o.AutoGenerateChapterIntervalMinutes) {
		return nil, false
	}
	return o.AutoGenerateChapterIntervalMinutes, true
}
...
// SetAutoGenerateChapterIntervalMinutes gets a reference to the given int32 and assigns it to the AutoGenerateChapterIntervalMinutes field.
func (o *LibraryOptions) SetAutoGenerateChapterIntervalMinutes(v int32) {
	o.AutoGenerateChapterIntervalMinutes = &v
}
...
// GetForceCollapseSingleItemFolders returns the ForceCollapseSingleItemFolders field value if set, zero value otherwise.
func (o *LibraryOptions) GetForceCollapseSingleItemFolders() bool {
	if o == nil || IsNil(o.ForceCollapseSingleItemFolders) {
		var ret bool
		return ret
	}
	return *o.ForceCollapseSingleItemFolders
}

// GetForceCollapseSingleItemFoldersOk returns a tuple with the ForceCollapseSingleItemFolders field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LibraryOptions) GetForceCollapseSingleItemFoldersOk() (*bool, bool) {
	if o == nil || IsNil(o.ForceCollapseSingleItemFolders) {
		return nil, false
	}
	return o.ForceCollapseSingleItemFolders, true
}
...
// SetForceCollapseSingleItemFolders gets a reference to the given bool and assigns it to the ForceCollapseSingleItemFolders field.
func (o *LibraryOptions) SetForceCollapseSingleItemFolders(v bool) {
	o.ForceCollapseSingleItemFolders = &v
}
...
// GetEnableMultiVersionByFiles returns the EnableMultiVersionByFiles field value if set, zero value otherwise.
func (o *LibraryOptions) GetEnableMultiVersionByFiles() bool {
	if o == nil || IsNil(o.EnableMultiVersionByFiles) {
		var ret bool
		return ret
	}
	return *o.EnableMultiVersionByFiles
}

// GetEnableMultiVersionByFilesOk returns a tuple with the EnableMultiVersionByFiles field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LibraryOptions) GetEnableMultiVersionByFilesOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableMultiVersionByFiles) {
		return nil, false
	}
	return o.EnableMultiVersionByFiles, true
}
...
// SetEnableMultiVersionByFiles gets a reference to the given bool and assigns it to the EnableMultiVersionByFiles field.
func (o *LibraryOptions) SetEnableMultiVersionByFiles(v bool) {
	o.EnableMultiVersionByFiles = &v
}

// GetEnableMultiVersionByMetadata returns the EnableMultiVersionByMetadata field value if set, zero value otherwise.
func (o *LibraryOptions) GetEnableMultiVersionByMetadata() bool {
	if o == nil || IsNil(o.EnableMultiVersionByMetadata) {
		var ret bool
		return ret
	}
	return *o.EnableMultiVersionByMetadata
}

// GetEnableMultiVersionByMetadataOk returns a tuple with the EnableMultiVersionByMetadata field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LibraryOptions) GetEnableMultiVersionByMetadataOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableMultiVersionByMetadata) {
		return nil, false
	}
	return o.EnableMultiVersionByMetadata, true
}
...
// SetEnableMultiVersionByMetadata gets a reference to the given bool and assigns it to the EnableMultiVersionByMetadata field.
func (o *LibraryOptions) SetEnableMultiVersionByMetadata(v bool) {
	o.EnableMultiVersionByMetadata = &v
}

// GetEnableMultiPartItems returns the EnableMultiPartItems field value if set, zero value otherwise.
func (o *LibraryOptions) GetEnableMultiPartItems() bool {
	if o == nil || IsNil(o.EnableMultiPartItems) {
		var ret bool
		return ret
	}
	return *o.EnableMultiPartItems
}

// GetEnableMultiPartItemsOk returns a tuple with the EnableMultiPartItems field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LibraryOptions) GetEnableMultiPartItemsOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableMultiPartItems) {
		return nil, false
	}
	return o.EnableMultiPartItems, true
}
...
// SetEnableMultiPartItems gets a reference to the given bool and assigns it to the EnableMultiPartItems field.
func (o *LibraryOptions) SetEnableMultiPartItems(v bool) {
	o.EnableMultiPartItems = &v
}
...
func (o LibraryOptions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CacheImages) {
		toSerialize["CacheImages"] = o.CacheImages
	}
	if !IsNil(o.ExcludeFromSearch) {
		toSerialize["ExcludeFromSearch"] = o.ExcludeFromSearch
	}
	if !IsNil(o.EnablePlexIgnore) {
		toSerialize["EnablePlexIgnore"] = o.EnablePlexIgnore
	}
	...
	if !IsNil(o.MergeTopLevelFolders) {
		toSerialize["MergeTopLevelFolders"] = o.MergeTopLevelFolders
	}
	if !IsNil(o.AutoGenerateChapterIntervalMinutes) {
		toSerialize["AutoGenerateChapterIntervalMinutes"] = o.AutoGenerateChapterIntervalMinutes
	}
	...
	if !IsNil(o.ForceCollapseSingleItemFolders) {
		toSerialize["ForceCollapseSingleItemFolders"] = o.ForceCollapseSingleItemFolders
	}
	...
	if !IsNil(o.EnableMultiVersionByFiles) {
		toSerialize["EnableMultiVersionByFiles"] = o.EnableMultiVersionByFiles
	}
	if !IsNil(o.EnableMultiVersionByMetadata) {
		toSerialize["EnableMultiVersionByMetadata"] = o.EnableMultiVersionByMetadata
	}
	if !IsNil(o.EnableMultiPartItems) {
		toSerialize["EnableMultiPartItems"] = o.EnableMultiPartItems
	}
