...
// checks if the BitRate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BitRate{}
...
// NewBitRate instantiates a new BitRate object
...
// NewBitRateWithDefaults instantiates a new BitRate object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBitRateWithDefaults() *BitRate {
	this := BitRate{}
	return &this
}

// GetBps returns the Bps field value if set, zero value otherwise.
func (o *BitRate) GetBps() int64 {
...
func (o *BitRate) GetBpsOk() (*int64, bool) {
	if o == nil || IsNil(o.Bps) {
		return nil, false
	}
	return o.Bps, true
...
// and a boolean to check if the value has been set.
func (o *BitRate) GetKbpsOk() (*float64, bool) {
	if o == nil || IsNil(o.Kbps) {
		return nil, false
	}
	return o.Kbps, true
...
// and a boolean to check if the value has been set.
func (o *BitRate) GetMbpsOk() (*float64, bool) {
	if o == nil || IsNil(o.Mbps) {
		return nil, false
	}
	return o.Mbps, true
...
func (o *BitRate) SetMbps(v float64) {
	o.Mbps = &v
}
...
func (o BitRate) ToMap() (map[string]interface{}, error) {
...
type NullableBitRate struct {
	value *BitRate
	isSet bool
}

func (v NullableBitRate) Get() *BitRate {
	return v.value
}

func (v *NullableBitRate) Set(val *BitRate) {
	v.value = val
	v.isSet = true
}

func (v NullableBitRate) IsSet() bool {
	return v.isSet
}

func (v *NullableBitRate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBitRate(val *BitRate) *NullableBitRate {
	return &NullableBitRate{value: val, isSet: true}
}

func (v NullableBitRate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBitRate) UnmarshalJSON(src []byte) error {
	v.isSet = true
