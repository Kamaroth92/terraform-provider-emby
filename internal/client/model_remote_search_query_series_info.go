...
// checks if the RemoteSearchQuerySeriesInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSearchQuerySeriesInfo{}

// RemoteSearchQuerySeriesInfo struct for RemoteSearchQuerySeriesInfo
...
func NewRemoteSearchQuerySeriesInfo() *RemoteSearchQuerySeriesInfo {
	this := RemoteSearchQuerySeriesInfo{}
	return &this
}
...
// SetSearchInfo gets a reference to the given SeriesInfo and assigns it to the SearchInfo field.
...
func (o RemoteSearchQuerySeriesInfo) MarshalJSON() ([]byte, error) {
...
func (o RemoteSearchQuerySeriesInfo) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteSearchQuerySeriesInfo struct {
	value *RemoteSearchQuerySeriesInfo
	isSet bool
}

func (v NullableRemoteSearchQuerySeriesInfo) Get() *RemoteSearchQuerySeriesInfo {
	return v.value
}

func (v *NullableRemoteSearchQuerySeriesInfo) Set(val *RemoteSearchQuerySeriesInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSearchQuerySeriesInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSearchQuerySeriesInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSearchQuerySeriesInfo(val *RemoteSearchQuerySeriesInfo) *NullableRemoteSearchQuerySeriesInfo {
	return &NullableRemoteSearchQuerySeriesInfo{value: val, isSet: true}
}

func (v NullableRemoteSearchQuerySeriesInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSearchQuerySeriesInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
