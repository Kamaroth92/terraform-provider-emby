...
type PersonsServiceAPI interface {
	...
	*/
	...
	GetPersonsExecute(r ApiGetPersonsRequest) (*QueryResultBaseItemDto, *http.Response, error)
	...
	@return ApiGetPersonsByNameRequest
	*/
	GetPersonsByName(ctx context.Context, name string) ApiGetPersonsByNameRequest

	// GetPersonsByNameExecute executes the request
	//  @return BaseItemDto
	GetPersonsByNameExecute(r ApiGetPersonsByNameRequest) (*BaseItemDto, *http.Response, error)
}
...
func (r ApiGetPersonsRequest) ArtistType(artistType string) ApiGetPersonsRequest {
	r.artistType = &artistType
	return r
}

// Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
func (r ApiGetPersonsRequest) MaxOfficialRating(maxOfficialRating string) ApiGetPersonsRequest {
	r.maxOfficialRating = &maxOfficialRating
	return r
}

// Optional filter by items with theme songs.
func (r ApiGetPersonsRequest) HasThemeSong(hasThemeSong bool) ApiGetPersonsRequest {
	r.hasThemeSong = &hasThemeSong
	return r
}

// Optional filter by items with theme videos.
func (r ApiGetPersonsRequest) HasThemeVideo(hasThemeVideo bool) ApiGetPersonsRequest {
	r.hasThemeVideo = &hasThemeVideo
	return r
}

// Optional filter by items with subtitles.
func (r ApiGetPersonsRequest) HasSubtitles(hasSubtitles bool) ApiGetPersonsRequest {
	r.hasSubtitles = &hasSubtitles
	return r
}

// Optional filter by items with special features.
func (r ApiGetPersonsRequest) HasSpecialFeature(hasSpecialFeature bool) ApiGetPersonsRequest {
	r.hasSpecialFeature = &hasSpecialFeature
	return r
}

// Optional filter by items with trailers.
func (r ApiGetPersonsRequest) HasTrailer(hasTrailer bool) ApiGetPersonsRequest {
	r.hasTrailer = &hasTrailer
	return r
}

// Optional. Filter by special season.
func (r ApiGetPersonsRequest) IsSpecialSeason(isSpecialSeason bool) ApiGetPersonsRequest {
	r.isSpecialSeason = &isSpecialSeason
	return r
}

// Optional. Return items that are siblings of a supplied item.
func (r ApiGetPersonsRequest) AdjacentTo(adjacentTo string) ApiGetPersonsRequest {
	r.adjacentTo = &adjacentTo
	return r
}

// Optional. Skip through the list until a given item is found.
func (r ApiGetPersonsRequest) StartItemId(startItemId string) ApiGetPersonsRequest {
	r.startItemId = &startItemId
	return r
}

// Optional filter by minimum index number.
func (r ApiGetPersonsRequest) MinIndexNumber(minIndexNumber int32) ApiGetPersonsRequest {
	r.minIndexNumber = &minIndexNumber
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetPersonsRequest) MinStartDate(minStartDate time.Time) ApiGetPersonsRequest {
	r.minStartDate = &minStartDate
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r ApiGetPersonsRequest) MaxStartDate(maxStartDate time.Time) ApiGetPersonsRequest {
	r.maxStartDate = &maxStartDate
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetPersonsRequest) MinEndDate(minEndDate time.Time) ApiGetPersonsRequest {
	r.minEndDate = &minEndDate
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r ApiGetPersonsRequest) MaxEndDate(maxEndDate time.Time) ApiGetPersonsRequest {
	r.maxEndDate = &maxEndDate
	return r
}

// Optional filter by minimum number of game players.
func (r ApiGetPersonsRequest) MinPlayers(minPlayers int32) ApiGetPersonsRequest {
	r.minPlayers = &minPlayers
	return r
}

// Optional filter by maximum number of game players.
func (r ApiGetPersonsRequest) MaxPlayers(maxPlayers int32) ApiGetPersonsRequest {
	r.maxPlayers = &maxPlayers
	return r
}

// Optional filter by parent index number.
func (r ApiGetPersonsRequest) ParentIndexNumber(parentIndexNumber int32) ApiGetPersonsRequest {
	r.parentIndexNumber = &parentIndexNumber
	return r
}

// Optional filter by items that have or do not have a parental rating
func (r ApiGetPersonsRequest) HasParentalRating(hasParentalRating bool) ApiGetPersonsRequest {
	r.hasParentalRating = &hasParentalRating
	return r
}

// Optional filter by items that are HD or not.
func (r ApiGetPersonsRequest) IsHD(isHD bool) ApiGetPersonsRequest {
	r.isHD = &isHD
	return r
}

// Optional filter by items that are unaired episodes or not.
func (r ApiGetPersonsRequest) IsUnaired(isUnaired bool) ApiGetPersonsRequest {
	r.isUnaired = &isUnaired
	return r
}

// Optional filter by minimum community rating.
func (r ApiGetPersonsRequest) MinCommunityRating(minCommunityRating float64) ApiGetPersonsRequest {
	r.minCommunityRating = &minCommunityRating
	return r
}

// Optional filter by minimum critic rating.
func (r ApiGetPersonsRequest) MinCriticRating(minCriticRating float64) ApiGetPersonsRequest {
	r.minCriticRating = &minCriticRating
	return r
}

// Gets all episodes that aired during a season, including specials.
func (r ApiGetPersonsRequest) AiredDuringSeason(airedDuringSeason int32) ApiGetPersonsRequest {
	r.airedDuringSeason = &airedDuringSeason
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetPersonsRequest) MinPremiereDate(minPremiereDate time.Time) ApiGetPersonsRequest {
	r.minPremiereDate = &minPremiereDate
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetPersonsRequest) MinDateLastSaved(minDateLastSaved time.Time) ApiGetPersonsRequest {
	r.minDateLastSaved = &minDateLastSaved
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetPersonsRequest) MinDateLastSavedForUser(minDateLastSavedForUser time.Time) ApiGetPersonsRequest {
	r.minDateLastSavedForUser = &minDateLastSavedForUser
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r ApiGetPersonsRequest) MaxPremiereDate(maxPremiereDate time.Time) ApiGetPersonsRequest {
	r.maxPremiereDate = &maxPremiereDate
	return r
}

// Optional filter by items that have an overview or not.
func (r ApiGetPersonsRequest) HasOverview(hasOverview bool) ApiGetPersonsRequest {
	r.hasOverview = &hasOverview
	return r
}

// Optional filter by items that have an imdb id or not.
func (r ApiGetPersonsRequest) HasImdbId(hasImdbId bool) ApiGetPersonsRequest {
	r.hasImdbId = &hasImdbId
	return r
}

// Optional filter by items that have a tmdb id or not.
func (r ApiGetPersonsRequest) HasTmdbId(hasTmdbId bool) ApiGetPersonsRequest {
	r.hasTmdbId = &hasTmdbId
	return r
}

// Optional filter by items that have a tvdb id or not.
func (r ApiGetPersonsRequest) HasTvdbId(hasTvdbId bool) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) ExcludeItemIds(excludeItemIds string) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) Recursive(recursive bool) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) SortOrder(sortOrder string) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) Fields(fields string) ApiGetPersonsRequest {
	r.fields = &fields
	return r
}

// Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
func (r ApiGetPersonsRequest) ExcludeItemTypes(excludeItemTypes string) ApiGetPersonsRequest {
	r.excludeItemTypes = &excludeItemTypes
	return r
}

// Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
func (r ApiGetPersonsRequest) IncludeItemTypes(includeItemTypes string) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) AnyProviderIdEquals(anyProviderIdEquals string) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) Filters(filters string) ApiGetPersonsRequest {
	r.filters = &filters
	return r
}
...
func (r ApiGetPersonsRequest) IsMovie(isMovie bool) ApiGetPersonsRequest {
	r.isMovie = &isMovie
	return r
}

// Optional filter for series.
func (r ApiGetPersonsRequest) IsSeries(isSeries bool) ApiGetPersonsRequest {
	r.isSeries = &isSeries
	return r
}

// Optional filter for folders.
func (r ApiGetPersonsRequest) IsFolder(isFolder bool) ApiGetPersonsRequest {
	r.isFolder = &isFolder
	return r
}

// Optional filter for news.
func (r ApiGetPersonsRequest) IsNews(isNews bool) ApiGetPersonsRequest {
	r.isNews = &isNews
	return r
}

// Optional filter for kids.
func (r ApiGetPersonsRequest) IsKids(isKids bool) ApiGetPersonsRequest {
	r.isKids = &isKids
	return r
}

// Optional filter for sports.
func (r ApiGetPersonsRequest) IsSports(isSports bool) ApiGetPersonsRequest {
	r.isSports = &isSports
	return r
}

// Optional filter for IsNew.
func (r ApiGetPersonsRequest) IsNew(isNew bool) ApiGetPersonsRequest {
	r.isNew = &isNew
	return r
}

// Optional filter for IsPremiere.
func (r ApiGetPersonsRequest) IsPremiere(isPremiere bool) ApiGetPersonsRequest {
	r.isPremiere = &isPremiere
	return r
}

// Optional filter for IsNewOrPremiere.
func (r ApiGetPersonsRequest) IsNewOrPremiere(isNewOrPremiere bool) ApiGetPersonsRequest {
	r.isNewOrPremiere = &isNewOrPremiere
	return r
}

// Optional filter for IsRepeat.
func (r ApiGetPersonsRequest) IsRepeat(isRepeat bool) ApiGetPersonsRequest {
	r.isRepeat = &isRepeat
	return r
}

// ProjectToMedia
func (r ApiGetPersonsRequest) ProjectToMedia(projectToMedia bool) ApiGetPersonsRequest {
	r.projectToMedia = &projectToMedia
	return r
}

// Optional filter by MediaType. Allows multiple, comma delimited.
func (r ApiGetPersonsRequest) MediaTypes(mediaTypes string) ApiGetPersonsRequest {
	r.mediaTypes = &mediaTypes
	return r
}

// Optional. If specified, results will be filtered based on those containing image types. This allows multiple, comma delimited.
func (r ApiGetPersonsRequest) ImageTypes(imageTypes string) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) IsPlayed(isPlayed bool) ApiGetPersonsRequest {
	r.isPlayed = &isPlayed
	return r
}

// Optional. If specified, results will be filtered based on genre. This allows multiple, pipe delimeted.
func (r ApiGetPersonsRequest) Genres(genres string) ApiGetPersonsRequest {
	r.genres = &genres
	return r
}

// Optional. If specified, results will be filtered based on OfficialRating. This allows multiple, pipe delimeted.
func (r ApiGetPersonsRequest) OfficialRatings(officialRatings string) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) Tags(tags string) ApiGetPersonsRequest {
	r.tags = &tags
	return r
}

// Optional. If specified, results will be filtered based on tag. This allows multiple, pipe delimeted.
func (r ApiGetPersonsRequest) ExcludeTags(excludeTags string) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) Years(years string) ApiGetPersonsRequest {
	r.years = &years
	return r
}
...
func (r ApiGetPersonsRequest) EnableImageTypes(enableImageTypes string) ApiGetPersonsRequest {
	r.enableImageTypes = &enableImageTypes
	return r
}

// Optional. If specified, results will be filtered to include only those containing the specified person.
func (r ApiGetPersonsRequest) Person(person string) ApiGetPersonsRequest {
	r.person = &person
	return r
}

// Optional. If specified, results will be filtered to include only those containing the specified person.
func (r ApiGetPersonsRequest) PersonIds(personIds string) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) Studios(studios string) ApiGetPersonsRequest {
	r.studios = &studios
	return r
}

// Optional. If specified, results will be filtered based on studio. This allows multiple, pipe delimeted.
func (r ApiGetPersonsRequest) StudioIds(studioIds string) ApiGetPersonsRequest {
	r.studioIds = &studioIds
	return r
}

// Optional. If specified, results will be filtered based on artist. This allows multiple, pipe delimeted.
func (r ApiGetPersonsRequest) Artists(artists string) ApiGetPersonsRequest {
	r.artists = &artists
	return r
}

// Optional. If specified, results will be filtered based on artist. This allows multiple, pipe delimeted.
func (r ApiGetPersonsRequest) ArtistIds(artistIds string) ApiGetPersonsRequest {
	r.artistIds = &artistIds
	return r
}

// Optional. If specified, results will be filtered based on album. This allows multiple, pipe delimeted.
func (r ApiGetPersonsRequest) Albums(albums string) ApiGetPersonsRequest {
	r.albums = &albums
	return r
}
...
func (r ApiGetPersonsRequest) VideoTypes(videoTypes string) ApiGetPersonsRequest {
	r.videoTypes = &videoTypes
	return r
}

// Optional filter by Container. Allows multiple, comma delimeted.
func (r ApiGetPersonsRequest) Containers(containers string) ApiGetPersonsRequest {
	r.containers = &containers
	return r
}

// Optional filter by AudioCodec. Allows multiple, comma delimeted.
func (r ApiGetPersonsRequest) AudioCodecs(audioCodecs string) ApiGetPersonsRequest {
	r.audioCodecs = &audioCodecs
	return r
}

// Optional filter by AudioLayout. Allows multiple, comma delimeted.
func (r ApiGetPersonsRequest) AudioLayouts(audioLayouts string) ApiGetPersonsRequest {
	r.audioLayouts = &audioLayouts
	return r
}

// Optional filter by VideoCodec. Allows multiple, comma delimeted.
func (r ApiGetPersonsRequest) VideoCodecs(videoCodecs string) ApiGetPersonsRequest {
	r.videoCodecs = &videoCodecs
	return r
}

// Optional filter by ExtendedVideoType. Allows multiple, comma delimeted.
func (r ApiGetPersonsRequest) ExtendedVideoTypes(extendedVideoTypes string) ApiGetPersonsRequest {
	r.extendedVideoTypes = &extendedVideoTypes
	return r
}

// Optional filter by SubtitleCodec. Allows multiple, comma delimeted.
func (r ApiGetPersonsRequest) SubtitleCodecs(subtitleCodecs string) ApiGetPersonsRequest {
	r.subtitleCodecs = &subtitleCodecs
	return r
}

// Optional filter by Path.
func (r ApiGetPersonsRequest) Path(path string) ApiGetPersonsRequest {
	r.path = &path
	return r
}
...
func (r ApiGetPersonsRequest) MinOfficialRating(minOfficialRating string) ApiGetPersonsRequest {
	r.minOfficialRating = &minOfficialRating
	return r
}

// Optional filter by items that are locked.
func (r ApiGetPersonsRequest) IsLocked(isLocked bool) ApiGetPersonsRequest {
	r.isLocked = &isLocked
	return r
}

// Optional filter by items that are placeholders
func (r ApiGetPersonsRequest) IsPlaceHolder(isPlaceHolder bool) ApiGetPersonsRequest {
	r.isPlaceHolder = &isPlaceHolder
	return r
}

// Optional filter by items that have official ratings
func (r ApiGetPersonsRequest) HasOfficialRating(hasOfficialRating bool) ApiGetPersonsRequest {
	r.hasOfficialRating = &hasOfficialRating
	return r
}

// Whether or not to hide items behind their boxsets.
func (r ApiGetPersonsRequest) GroupItemsIntoCollections(groupItemsIntoCollections bool) ApiGetPersonsRequest {
	r.groupItemsIntoCollections = &groupItemsIntoCollections
	return r
}

// Optional filter by items that are 3D, or not.
func (r ApiGetPersonsRequest) Is3D(is3D bool) ApiGetPersonsRequest {
	r.is3D = &is3D
	return r
}

// Optional filter by Series Status. Allows multiple, comma delimeted.
func (r ApiGetPersonsRequest) SeriesStatus(seriesStatus string) ApiGetPersonsRequest {
...
// Optional filter by items whose name is sorted equally or greater than a given input string.
func (r ApiGetPersonsRequest) ArtistStartsWithOrGreater(artistStartsWithOrGreater string) ApiGetPersonsRequest {
	r.artistStartsWithOrGreater = &artistStartsWithOrGreater
	return r
}

// Optional filter by items whose name is sorted equally or greater than a given input string.
func (r ApiGetPersonsRequest) AlbumArtistStartsWithOrGreater(albumArtistStartsWithOrGreater string) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) Execute() (*QueryResultBaseItemDto, *http.Response, error) {
...
Requires authentication as user
 ...
 @return ApiGetPersonsRequest
*/
func (a *PersonsServiceAPIService) GetPersons(ctx context.Context) ApiGetPersonsRequest {
	return ApiGetPersonsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return QueryResultBaseItemDto
func (a *PersonsServiceAPIService) GetPersonsExecute(r ApiGetPersonsRequest) (*QueryResultBaseItemDto, *http.Response, error) {
	var (
...
type ApiGetPersonsByNameRequest struct {
	ctx context.Context
	ApiService PersonsServiceAPI
	name string
	userId *string
...
func (r ApiGetPersonsByNameRequest) UserId(userId string) ApiGetPersonsByNameRequest {
	r.userId = &userId
	return r
}

func (r ApiGetPersonsByNameRequest) Execute() (*BaseItemDto, *http.Response, error) {
...
Requires authentication as user
 ...
 @return ApiGetPersonsByNameRequest
*/
func (a *PersonsServiceAPIService) GetPersonsByName(ctx context.Context, name string) ApiGetPersonsByNameRequest {
	return ApiGetPersonsByNameRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
// Execute executes the request
//  @return BaseItemDto
func (a *PersonsServiceAPIService) GetPersonsByNameExecute(r ApiGetPersonsByNameRequest) (*BaseItemDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
