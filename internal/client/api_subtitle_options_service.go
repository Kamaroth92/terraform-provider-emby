...
type SubtitleOptionsServiceAPI interface {
	...
	*/
	...
	// GetEncodingSubtitleoptionsExecute executes the request
	...
	*/
	...
	// PostEncodingSubtitleoptionsExecute executes the request
	PostEncodingSubtitleoptionsExecute(r ApiPostEncodingSubtitleoptionsRequest) (*http.Response, error)
}
...
func (r ApiGetEncodingSubtitleoptionsRequest) Execute() (*EditObjectContainer, *http.Response, error) {
...
// Binary stream
func (r ApiPostEncodingSubtitleoptionsRequest) Body(body *os.File) ApiPostEncodingSubtitleoptionsRequest {
	r.body = body
	return r
}

func (r ApiPostEncodingSubtitleoptionsRequest) Execute() (*http.Response, error) {
