...
// checks if the RemoteSearchQueryGameInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSearchQueryGameInfo{}

// RemoteSearchQueryGameInfo struct for RemoteSearchQueryGameInfo
...
func NewRemoteSearchQueryGameInfo() *RemoteSearchQueryGameInfo {
	this := RemoteSearchQueryGameInfo{}
	return &this
}
...
// SetSearchInfo gets a reference to the given GameInfo and assigns it to the SearchInfo field.
...
func (o RemoteSearchQueryGameInfo) MarshalJSON() ([]byte, error) {
...
func (o RemoteSearchQueryGameInfo) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteSearchQueryGameInfo struct {
	value *RemoteSearchQueryGameInfo
	isSet bool
}

func (v NullableRemoteSearchQueryGameInfo) Get() *RemoteSearchQueryGameInfo {
	return v.value
}

func (v *NullableRemoteSearchQueryGameInfo) Set(val *RemoteSearchQueryGameInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSearchQueryGameInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSearchQueryGameInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSearchQueryGameInfo(val *RemoteSearchQueryGameInfo) *NullableRemoteSearchQueryGameInfo {
	return &NullableRemoteSearchQueryGameInfo{value: val, isSet: true}
}

func (v NullableRemoteSearchQueryGameInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSearchQueryGameInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
