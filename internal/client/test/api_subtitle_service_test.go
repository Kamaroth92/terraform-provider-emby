...
func Test_embyclient_SubtitleServiceAPIService(t *testing.T) {
	...
	t.Run("Test SubtitleServiceAPIService GetVideosByIdByMediasourceidAttachmentsByIndexStream", func(t *testing.T) {
		...
		httpRes, err := apiClient.SubtitleServiceAPI.GetVideosByIdByMediasourceidAttachmentsByIndexStream(context.Background(), id, mediaSourceId, index).Execute()
	...
	t.Run("Test SubtitleServiceAPIService HeadItemsByIdByMediasourceidSubtitlesByIndexByStartpositionticksStreamByFormat", func(t *testing.T) {
		...
		httpRes, err := apiClient.SubtitleServiceAPI.HeadItemsByIdByMediasourceidSubtitlesByIndexByStartpositionticksStreamByFormat(context.Background(), id, mediaSourceId, index, format, startPositionTicks).Execute()
	...
	t.Run("Test SubtitleServiceAPIService HeadItemsByIdByMediasourceidSubtitlesByIndexStreamByFormat", func(t *testing.T) {
		...
		httpRes, err := apiClient.SubtitleServiceAPI.HeadItemsByIdByMediasourceidSubtitlesByIndexStreamByFormat(context.Background(), id, mediaSourceId, index, format).Execute()
	...
	t.Run("Test SubtitleServiceAPIService HeadVideosByIdByMediasourceidSubtitlesByIndexByStartpositionticksStreamByFormat", func(t *testing.T) {
		...
		httpRes, err := apiClient.SubtitleServiceAPI.HeadVideosByIdByMediasourceidSubtitlesByIndexByStartpositionticksStreamByFormat(context.Background(), id, mediaSourceId, index, format, startPositionTicks).Execute()
	...
	t.Run("Test SubtitleServiceAPIService HeadVideosByIdByMediasourceidSubtitlesByIndexStreamByFormat", func(t *testing.T) {
		...
		httpRes, err := apiClient.SubtitleServiceAPI.HeadVideosByIdByMediasourceidSubtitlesByIndexStreamByFormat(context.Background(), id, mediaSourceId, index, format).Execute()
