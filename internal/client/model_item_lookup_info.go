...
// checks if the ItemLookupInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemLookupInfo{}

// ItemLookupInfo struct for ItemLookupInfo
...
func (o *ItemLookupInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *ItemLookupInfo) SetIndexNumberNil() {
...
func (o *ItemLookupInfo) SetParentIndexNumberNil() {
...
func (o *ItemLookupInfo) SetPremiereDateNil() {
...
func (o ItemLookupInfo) MarshalJSON() ([]byte, error) {
...
func (o ItemLookupInfo) ToMap() (map[string]interface{}, error) {
...
type NullableItemLookupInfo struct {
	value *ItemLookupInfo
	isSet bool
}

func (v NullableItemLookupInfo) Get() *ItemLookupInfo {
	return v.value
}

func (v *NullableItemLookupInfo) Set(val *ItemLookupInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableItemLookupInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableItemLookupInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemLookupInfo(val *ItemLookupInfo) *NullableItemLookupInfo {
	return &NullableItemLookupInfo{value: val, isSet: true}
}

func (v NullableItemLookupInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemLookupInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
