...
// SetDeliveryMethod gets a reference to the given SubtitleDeliveryMethod and assigns it to the DeliveryMethod field.
...
// GetIsChunkedResponse returns the IsChunkedResponse field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MediaStream) GetIsChunkedResponse() bool {
	if o == nil || IsNil(o.IsChunkedResponse.Get()) {
		var ret bool
		return ret
	}
	return *o.IsChunkedResponse.Get()
}

// GetIsChunkedResponseOk returns a tuple with the IsChunkedResponse field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetIsChunkedResponse gets a reference to the given NullableBool and assigns it to the IsChunkedResponse field.
...
// SetExtendedVideoType gets a reference to the given ExtendedVideoTypes and assigns it to the ExtendedVideoType field.
...
// SetExtendedVideoSubType gets a reference to the given ExtendedVideoSubTypes and assigns it to the ExtendedVideoSubType field.
...
// SetSubtitleLocationType gets a reference to the given SubtitleLocationType and assigns it to the SubtitleLocationType field.
...
func (o MediaStream) ToMap() (map[string]interface{}, error) {
	...
	if o.IsChunkedResponse.IsSet() {
		toSerialize["IsChunkedResponse"] = o.IsChunkedResponse.Get()
	}
