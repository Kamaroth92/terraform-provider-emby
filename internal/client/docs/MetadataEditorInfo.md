...
**PersonExternalIdInfos** | Pointer to [**[]ExternalIdInfo**](ExternalIdInfo.md) |  | [optional] 
...
### GetPersonExternalIdInfos

`func (o *MetadataEditorInfo) GetPersonExternalIdInfos() []ExternalIdInfo`

GetPersonExternalIdInfos returns the PersonExternalIdInfos field if non-nil, zero value otherwise.

### GetPersonExternalIdInfosOk

`func (o *MetadataEditorInfo) GetPersonExternalIdInfosOk() (*[]ExternalIdInfo, bool)`

GetPersonExternalIdInfosOk returns a tuple with the PersonExternalIdInfos field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetPersonExternalIdInfos

`func (o *MetadataEditorInfo) SetPersonExternalIdInfos(v []ExternalIdInfo)`

SetPersonExternalIdInfos sets PersonExternalIdInfos field to given value.

### HasPersonExternalIdInfos
