...
type DiagnosticsPluginServiceAPI interface {
	...
	*/
	...
	// GetEncodingdiagnosticsDiagnosticoptionsExecute executes the request
	...
	*/
	...
	// PostEncodingdiagnosticsDiagnosticoptionsExecute executes the request
	PostEncodingdiagnosticsDiagnosticoptionsExecute(r ApiPostEncodingdiagnosticsDiagnosticoptionsRequest) (*http.Response, error)
}

// DiagnosticsPluginServiceAPIService DiagnosticsPluginServiceAPI service
...
func (r ApiGetEncodingdiagnosticsDiagnosticoptionsRequest) Execute() (*EditObjectContainer, *http.Response, error) {
	return r.ApiService.GetEncodingdiagnosticsDiagnosticoptionsExecute(r)
}
...
func (a *DiagnosticsPluginServiceAPIService) GetEncodingdiagnosticsDiagnosticoptionsExecute(r ApiGetEncodingdiagnosticsDiagnosticoptionsRequest) (*EditObjectContainer, *http.Response, error) {
	...
	localVarPath := localBasePath + "/EncodingDiagnostics/DiagnosticOptions"
...
// Binary stream
func (r ApiPostEncodingdiagnosticsDiagnosticoptionsRequest) Body(body *os.File) ApiPostEncodingdiagnosticsDiagnosticoptionsRequest {
	r.body = body
	return r
}

func (r ApiPostEncodingdiagnosticsDiagnosticoptionsRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostEncodingdiagnosticsDiagnosticoptionsExecute(r)
}
