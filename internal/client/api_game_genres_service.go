...
type GameGenresServiceAPI interface {
	...
	*/
	...
	// GetGamegenresExecute executes the request
	...
	*/
	...
	// GetGamegenresByNameExecute executes the request
	//  @return BaseItemDto
	GetGamegenresByNameExecute(r ApiGetGamegenresByNameRequest) (*BaseItemDto, *http.Response, error)
}
...
func (r ApiGetGamegenresRequest) ArtistType(artistType string) ApiGetGamegenresRequest {
	r.artistType = &artistType
	return r
}

// Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
func (r ApiGetGamegenresRequest) MaxOfficialRating(maxOfficialRating string) ApiGetGamegenresRequest {
	r.maxOfficialRating = &maxOfficialRating
	return r
}

// Optional filter by items with theme songs.
func (r ApiGetGamegenresRequest) HasThemeSong(hasThemeSong bool) ApiGetGamegenresRequest {
	r.hasThemeSong = &hasThemeSong
	return r
}

// Optional filter by items with theme videos.
func (r ApiGetGamegenresRequest) HasThemeVideo(hasThemeVideo bool) ApiGetGamegenresRequest {
	r.hasThemeVideo = &hasThemeVideo
	return r
}

// Optional filter by items with subtitles.
func (r ApiGetGamegenresRequest) HasSubtitles(hasSubtitles bool) ApiGetGamegenresRequest {
	r.hasSubtitles = &hasSubtitles
	return r
}

// Optional filter by items with special features.
func (r ApiGetGamegenresRequest) HasSpecialFeature(hasSpecialFeature bool) ApiGetGamegenresRequest {
	r.hasSpecialFeature = &hasSpecialFeature
	return r
}

// Optional filter by items with trailers.
func (r ApiGetGamegenresRequest) HasTrailer(hasTrailer bool) ApiGetGamegenresRequest {
	r.hasTrailer = &hasTrailer
	return r
}

// Optional. Filter by special season.
func (r ApiGetGamegenresRequest) IsSpecialSeason(isSpecialSeason bool) ApiGetGamegenresRequest {
	r.isSpecialSeason = &isSpecialSeason
	return r
}

// Optional. Return items that are siblings of a supplied item.
func (r ApiGetGamegenresRequest) AdjacentTo(adjacentTo string) ApiGetGamegenresRequest {
	r.adjacentTo = &adjacentTo
	return r
}

// Optional. Skip through the list until a given item is found.
func (r ApiGetGamegenresRequest) StartItemId(startItemId string) ApiGetGamegenresRequest {
	r.startItemId = &startItemId
	return r
}

// Optional filter by minimum index number.
func (r ApiGetGamegenresRequest) MinIndexNumber(minIndexNumber int32) ApiGetGamegenresRequest {
	r.minIndexNumber = &minIndexNumber
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetGamegenresRequest) MinStartDate(minStartDate time.Time) ApiGetGamegenresRequest {
	r.minStartDate = &minStartDate
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r ApiGetGamegenresRequest) MaxStartDate(maxStartDate time.Time) ApiGetGamegenresRequest {
	r.maxStartDate = &maxStartDate
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetGamegenresRequest) MinEndDate(minEndDate time.Time) ApiGetGamegenresRequest {
	r.minEndDate = &minEndDate
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r ApiGetGamegenresRequest) MaxEndDate(maxEndDate time.Time) ApiGetGamegenresRequest {
	r.maxEndDate = &maxEndDate
	return r
}

// Optional filter by minimum number of game players.
func (r ApiGetGamegenresRequest) MinPlayers(minPlayers int32) ApiGetGamegenresRequest {
	r.minPlayers = &minPlayers
	return r
}

// Optional filter by maximum number of game players.
func (r ApiGetGamegenresRequest) MaxPlayers(maxPlayers int32) ApiGetGamegenresRequest {
	r.maxPlayers = &maxPlayers
	return r
}

// Optional filter by parent index number.
func (r ApiGetGamegenresRequest) ParentIndexNumber(parentIndexNumber int32) ApiGetGamegenresRequest {
	r.parentIndexNumber = &parentIndexNumber
	return r
}

// Optional filter by items that have or do not have a parental rating
func (r ApiGetGamegenresRequest) HasParentalRating(hasParentalRating bool) ApiGetGamegenresRequest {
	r.hasParentalRating = &hasParentalRating
	return r
}

// Optional filter by items that are HD or not.
func (r ApiGetGamegenresRequest) IsHD(isHD bool) ApiGetGamegenresRequest {
	r.isHD = &isHD
	return r
}

// Optional filter by items that are unaired episodes or not.
func (r ApiGetGamegenresRequest) IsUnaired(isUnaired bool) ApiGetGamegenresRequest {
	r.isUnaired = &isUnaired
	return r
}

// Optional filter by minimum community rating.
func (r ApiGetGamegenresRequest) MinCommunityRating(minCommunityRating float64) ApiGetGamegenresRequest {
	r.minCommunityRating = &minCommunityRating
	return r
}

// Optional filter by minimum critic rating.
func (r ApiGetGamegenresRequest) MinCriticRating(minCriticRating float64) ApiGetGamegenresRequest {
	r.minCriticRating = &minCriticRating
	return r
}

// Gets all episodes that aired during a season, including specials.
func (r ApiGetGamegenresRequest) AiredDuringSeason(airedDuringSeason int32) ApiGetGamegenresRequest {
	r.airedDuringSeason = &airedDuringSeason
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetGamegenresRequest) MinPremiereDate(minPremiereDate time.Time) ApiGetGamegenresRequest {
	r.minPremiereDate = &minPremiereDate
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetGamegenresRequest) MinDateLastSaved(minDateLastSaved time.Time) ApiGetGamegenresRequest {
	r.minDateLastSaved = &minDateLastSaved
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetGamegenresRequest) MinDateLastSavedForUser(minDateLastSavedForUser time.Time) ApiGetGamegenresRequest {
	r.minDateLastSavedForUser = &minDateLastSavedForUser
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r ApiGetGamegenresRequest) MaxPremiereDate(maxPremiereDate time.Time) ApiGetGamegenresRequest {
	r.maxPremiereDate = &maxPremiereDate
	return r
}

// Optional filter by items that have an overview or not.
func (r ApiGetGamegenresRequest) HasOverview(hasOverview bool) ApiGetGamegenresRequest {
	r.hasOverview = &hasOverview
	return r
}

// Optional filter by items that have an imdb id or not.
func (r ApiGetGamegenresRequest) HasImdbId(hasImdbId bool) ApiGetGamegenresRequest {
	r.hasImdbId = &hasImdbId
	return r
}

// Optional filter by items that have a tmdb id or not.
func (r ApiGetGamegenresRequest) HasTmdbId(hasTmdbId bool) ApiGetGamegenresRequest {
	r.hasTmdbId = &hasTmdbId
	return r
}

// Optional filter by items that have a tvdb id or not.
func (r ApiGetGamegenresRequest) HasTvdbId(hasTvdbId bool) ApiGetGamegenresRequest {
...
func (r ApiGetGamegenresRequest) ExcludeItemIds(excludeItemIds string) ApiGetGamegenresRequest {
	r.excludeItemIds = &excludeItemIds
	return r
}

// Optional. The record index to start at. All items with a lower index will be dropped from the results.
func (r ApiGetGamegenresRequest) StartIndex(startIndex int32) ApiGetGamegenresRequest {
	r.startIndex = &startIndex
	return r
}

// Optional. The maximum number of records to return
func (r ApiGetGamegenresRequest) Limit(limit int32) ApiGetGamegenresRequest {
	r.limit = &limit
	return r
}

// When searching within folders, this determines whether or not the search will be recursive. true/false
func (r ApiGetGamegenresRequest) Recursive(recursive bool) ApiGetGamegenresRequest {
	r.recursive = &recursive
	return r
}

// Enter a search term to perform a search request
func (r ApiGetGamegenresRequest) SearchTerm(searchTerm string) ApiGetGamegenresRequest {
	r.searchTerm = &searchTerm
	return r
}

// Sort Order - Ascending,Descending
func (r ApiGetGamegenresRequest) SortOrder(sortOrder string) ApiGetGamegenresRequest {
	r.sortOrder = &sortOrder
	return r
}

// Specify this to localize the search to a specific item or folder. Omit to use the root
func (r ApiGetGamegenresRequest) ParentId(parentId string) ApiGetGamegenresRequest {
	r.parentId = &parentId
	return r
}
...
func (r ApiGetGamegenresRequest) Fields(fields string) ApiGetGamegenresRequest {
	r.fields = &fields
	return r
}

// Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
func (r ApiGetGamegenresRequest) ExcludeItemTypes(excludeItemTypes string) ApiGetGamegenresRequest {
	r.excludeItemTypes = &excludeItemTypes
	return r
}

// Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
func (r ApiGetGamegenresRequest) IncludeItemTypes(includeItemTypes string) ApiGetGamegenresRequest {
...
func (r ApiGetGamegenresRequest) AnyProviderIdEquals(anyProviderIdEquals string) ApiGetGamegenresRequest {
...
func (r ApiGetGamegenresRequest) Filters(filters string) ApiGetGamegenresRequest {
	r.filters = &filters
	return r
}

// Optional filter by items that are marked as favorite, or not.
func (r ApiGetGamegenresRequest) IsFavorite(isFavorite bool) ApiGetGamegenresRequest {
	r.isFavorite = &isFavorite
	return r
}

// Optional filter for movies.
func (r ApiGetGamegenresRequest) IsMovie(isMovie bool) ApiGetGamegenresRequest {
	r.isMovie = &isMovie
	return r
}

// Optional filter for series.
func (r ApiGetGamegenresRequest) IsSeries(isSeries bool) ApiGetGamegenresRequest {
	r.isSeries = &isSeries
	return r
}

// Optional filter for folders.
func (r ApiGetGamegenresRequest) IsFolder(isFolder bool) ApiGetGamegenresRequest {
	r.isFolder = &isFolder
	return r
}

// Optional filter for news.
func (r ApiGetGamegenresRequest) IsNews(isNews bool) ApiGetGamegenresRequest {
	r.isNews = &isNews
	return r
}

// Optional filter for kids.
func (r ApiGetGamegenresRequest) IsKids(isKids bool) ApiGetGamegenresRequest {
	r.isKids = &isKids
	return r
}

// Optional filter for sports.
func (r ApiGetGamegenresRequest) IsSports(isSports bool) ApiGetGamegenresRequest {
	r.isSports = &isSports
	return r
}

// Optional filter for IsNew.
func (r ApiGetGamegenresRequest) IsNew(isNew bool) ApiGetGamegenresRequest {
	r.isNew = &isNew
	return r
}

// Optional filter for IsPremiere.
func (r ApiGetGamegenresRequest) IsPremiere(isPremiere bool) ApiGetGamegenresRequest {
	r.isPremiere = &isPremiere
	return r
}

// Optional filter for IsNewOrPremiere.
func (r ApiGetGamegenresRequest) IsNewOrPremiere(isNewOrPremiere bool) ApiGetGamegenresRequest {
	r.isNewOrPremiere = &isNewOrPremiere
	return r
}

// Optional filter for IsRepeat.
func (r ApiGetGamegenresRequest) IsRepeat(isRepeat bool) ApiGetGamegenresRequest {
	r.isRepeat = &isRepeat
	return r
}

// ProjectToMedia
func (r ApiGetGamegenresRequest) ProjectToMedia(projectToMedia bool) ApiGetGamegenresRequest {
	r.projectToMedia = &projectToMedia
	return r
}

// Optional filter by MediaType. Allows multiple, comma delimited.
func (r ApiGetGamegenresRequest) MediaTypes(mediaTypes string) ApiGetGamegenresRequest {
	r.mediaTypes = &mediaTypes
	return r
}

// Optional. If specified, results will be filtered based on those containing image types. This allows multiple, comma delimited.
func (r ApiGetGamegenresRequest) ImageTypes(imageTypes string) ApiGetGamegenresRequest {
...
func (r ApiGetGamegenresRequest) SortBy(sortBy string) ApiGetGamegenresRequest {
	r.sortBy = &sortBy
	return r
}

// Optional filter by items that are played, or not.
func (r ApiGetGamegenresRequest) IsPlayed(isPlayed bool) ApiGetGamegenresRequest {
	r.isPlayed = &isPlayed
	return r
}

// Optional. If specified, results will be filtered based on genre. This allows multiple, pipe delimeted.
func (r ApiGetGamegenresRequest) Genres(genres string) ApiGetGamegenresRequest {
	r.genres = &genres
	return r
}

// Optional. If specified, results will be filtered based on OfficialRating. This allows multiple, pipe delimeted.
func (r ApiGetGamegenresRequest) OfficialRatings(officialRatings string) ApiGetGamegenresRequest {
...
func (r ApiGetGamegenresRequest) Tags(tags string) ApiGetGamegenresRequest {
	r.tags = &tags
	return r
}

// Optional. If specified, results will be filtered based on tag. This allows multiple, pipe delimeted.
func (r ApiGetGamegenresRequest) ExcludeTags(excludeTags string) ApiGetGamegenresRequest {
...
func (r ApiGetGamegenresRequest) Years(years string) ApiGetGamegenresRequest {
	r.years = &years
	return r
}

// Optional, include image information in output
func (r ApiGetGamegenresRequest) EnableImages(enableImages bool) ApiGetGamegenresRequest {
	r.enableImages = &enableImages
	return r
}

// Optional, include user data
func (r ApiGetGamegenresRequest) EnableUserData(enableUserData bool) ApiGetGamegenresRequest {
	r.enableUserData = &enableUserData
	return r
}

// Optional, the max number of images to return, per image type
func (r ApiGetGamegenresRequest) ImageTypeLimit(imageTypeLimit int32) ApiGetGamegenresRequest {
	r.imageTypeLimit = &imageTypeLimit
	return r
}

// Optional. The image types to include in the output.
func (r ApiGetGamegenresRequest) EnableImageTypes(enableImageTypes string) ApiGetGamegenresRequest {
	r.enableImageTypes = &enableImageTypes
	return r
}

// Optional. If specified, results will be filtered to include only those containing the specified person.
func (r ApiGetGamegenresRequest) Person(person string) ApiGetGamegenresRequest {
	r.person = &person
	return r
}

// Optional. If specified, results will be filtered to include only those containing the specified person.
func (r ApiGetGamegenresRequest) PersonIds(personIds string) ApiGetGamegenresRequest {
	r.personIds = &personIds
	return r
}

// Optional. If specified, along with Person, results will be filtered to include only those containing the specified person and PersonType. Allows multiple, comma-delimited
func (r ApiGetGamegenresRequest) PersonTypes(personTypes string) ApiGetGamegenresRequest {
...
func (r ApiGetGamegenresRequest) Studios(studios string) ApiGetGamegenresRequest {
	r.studios = &studios
	return r
}

// Optional. If specified, results will be filtered based on studio. This allows multiple, pipe delimeted.
func (r ApiGetGamegenresRequest) StudioIds(studioIds string) ApiGetGamegenresRequest {
	r.studioIds = &studioIds
	return r
}

// Optional. If specified, results will be filtered based on artist. This allows multiple, pipe delimeted.
func (r ApiGetGamegenresRequest) Artists(artists string) ApiGetGamegenresRequest {
	r.artists = &artists
	return r
}

// Optional. If specified, results will be filtered based on artist. This allows multiple, pipe delimeted.
func (r ApiGetGamegenresRequest) ArtistIds(artistIds string) ApiGetGamegenresRequest {
	r.artistIds = &artistIds
	return r
}

// Optional. If specified, results will be filtered based on album. This allows multiple, pipe delimeted.
func (r ApiGetGamegenresRequest) Albums(albums string) ApiGetGamegenresRequest {
	r.albums = &albums
	return r
}

// Optional. If specific items are needed, specify a list of item id&#39;s to retrieve. This allows multiple, comma delimited.
func (r ApiGetGamegenresRequest) Ids(ids string) ApiGetGamegenresRequest {
	r.ids = &ids
	return r
}

// Optional filter by VideoType (videofile, dvd, bluray, iso). Allows multiple, comma delimeted.
func (r ApiGetGamegenresRequest) VideoTypes(videoTypes string) ApiGetGamegenresRequest {
	r.videoTypes = &videoTypes
	return r
}

// Optional filter by Container. Allows multiple, comma delimeted.
func (r ApiGetGamegenresRequest) Containers(containers string) ApiGetGamegenresRequest {
	r.containers = &containers
	return r
}

// Optional filter by AudioCodec. Allows multiple, comma delimeted.
func (r ApiGetGamegenresRequest) AudioCodecs(audioCodecs string) ApiGetGamegenresRequest {
	r.audioCodecs = &audioCodecs
	return r
}

// Optional filter by AudioLayout. Allows multiple, comma delimeted.
func (r ApiGetGamegenresRequest) AudioLayouts(audioLayouts string) ApiGetGamegenresRequest {
	r.audioLayouts = &audioLayouts
	return r
}

// Optional filter by VideoCodec. Allows multiple, comma delimeted.
func (r ApiGetGamegenresRequest) VideoCodecs(videoCodecs string) ApiGetGamegenresRequest {
	r.videoCodecs = &videoCodecs
	return r
}

// Optional filter by ExtendedVideoType. Allows multiple, comma delimeted.
func (r ApiGetGamegenresRequest) ExtendedVideoTypes(extendedVideoTypes string) ApiGetGamegenresRequest {
	r.extendedVideoTypes = &extendedVideoTypes
	return r
}

// Optional filter by SubtitleCodec. Allows multiple, comma delimeted.
func (r ApiGetGamegenresRequest) SubtitleCodecs(subtitleCodecs string) ApiGetGamegenresRequest {
	r.subtitleCodecs = &subtitleCodecs
	return r
}

// Optional filter by Path.
func (r ApiGetGamegenresRequest) Path(path string) ApiGetGamegenresRequest {
	r.path = &path
	return r
}

// User Id
func (r ApiGetGamegenresRequest) UserId(userId string) ApiGetGamegenresRequest {
	r.userId = &userId
	return r
}

// Optional filter by minimum official rating (PG, PG-13, TV-MA, etc).
func (r ApiGetGamegenresRequest) MinOfficialRating(minOfficialRating string) ApiGetGamegenresRequest {
	r.minOfficialRating = &minOfficialRating
	return r
}

// Optional filter by items that are locked.
func (r ApiGetGamegenresRequest) IsLocked(isLocked bool) ApiGetGamegenresRequest {
	r.isLocked = &isLocked
	return r
}

// Optional filter by items that are placeholders
func (r ApiGetGamegenresRequest) IsPlaceHolder(isPlaceHolder bool) ApiGetGamegenresRequest {
	r.isPlaceHolder = &isPlaceHolder
	return r
}

// Optional filter by items that have official ratings
func (r ApiGetGamegenresRequest) HasOfficialRating(hasOfficialRating bool) ApiGetGamegenresRequest {
	r.hasOfficialRating = &hasOfficialRating
	return r
}

// Whether or not to hide items behind their boxsets.
func (r ApiGetGamegenresRequest) GroupItemsIntoCollections(groupItemsIntoCollections bool) ApiGetGamegenresRequest {
	r.groupItemsIntoCollections = &groupItemsIntoCollections
	return r
}

// Optional filter by items that are 3D, or not.
func (r ApiGetGamegenresRequest) Is3D(is3D bool) ApiGetGamegenresRequest {
	r.is3D = &is3D
	return r
}

// Optional filter by Series Status. Allows multiple, comma delimeted.
func (r ApiGetGamegenresRequest) SeriesStatus(seriesStatus string) ApiGetGamegenresRequest {
	r.seriesStatus = &seriesStatus
	return r
}

// Optional filter by items whose name is sorted equally or greater than a given input string.
func (r ApiGetGamegenresRequest) NameStartsWithOrGreater(nameStartsWithOrGreater string) ApiGetGamegenresRequest {
	r.nameStartsWithOrGreater = &nameStartsWithOrGreater
	return r
}

// Optional filter by items whose name is sorted equally or greater than a given input string.
func (r ApiGetGamegenresRequest) ArtistStartsWithOrGreater(artistStartsWithOrGreater string) ApiGetGamegenresRequest {
	r.artistStartsWithOrGreater = &artistStartsWithOrGreater
	return r
}

// Optional filter by items whose name is sorted equally or greater than a given input string.
func (r ApiGetGamegenresRequest) AlbumArtistStartsWithOrGreater(albumArtistStartsWithOrGreater string) ApiGetGamegenresRequest {
	r.albumArtistStartsWithOrGreater = &albumArtistStartsWithOrGreater
	return r
}

// Optional filter by items whose name is sorted equally than a given input string.
func (r ApiGetGamegenresRequest) NameStartsWith(nameStartsWith string) ApiGetGamegenresRequest {
	r.nameStartsWith = &nameStartsWith
	return r
}

// Optional filter by items whose name is equally or lesser than a given input string.
func (r ApiGetGamegenresRequest) NameLessThan(nameLessThan string) ApiGetGamegenresRequest {
	r.nameLessThan = &nameLessThan
	return r
}

func (r ApiGetGamegenresRequest) Execute() (*QueryResultBaseItemDto, *http.Response, error) {
...
func (r ApiGetGamegenresByNameRequest) UserId(userId string) ApiGetGamegenresByNameRequest {
	r.userId = &userId
	return r
}

func (r ApiGetGamegenresByNameRequest) Execute() (*BaseItemDto, *http.Response, error) {
