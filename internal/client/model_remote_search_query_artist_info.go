...
// checks if the RemoteSearchQueryArtistInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSearchQueryArtistInfo{}

// RemoteSearchQueryArtistInfo struct for RemoteSearchQueryArtistInfo
...
func NewRemoteSearchQueryArtistInfo() *RemoteSearchQueryArtistInfo {
	this := RemoteSearchQueryArtistInfo{}
	return &this
}
...
// SetSearchInfo gets a reference to the given ArtistInfo and assigns it to the SearchInfo field.
...
func (o RemoteSearchQueryArtistInfo) MarshalJSON() ([]byte, error) {
...
func (o RemoteSearchQueryArtistInfo) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteSearchQueryArtistInfo struct {
	value *RemoteSearchQueryArtistInfo
	isSet bool
}

func (v NullableRemoteSearchQueryArtistInfo) Get() *RemoteSearchQueryArtistInfo {
	return v.value
}

func (v *NullableRemoteSearchQueryArtistInfo) Set(val *RemoteSearchQueryArtistInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSearchQueryArtistInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSearchQueryArtistInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSearchQueryArtistInfo(val *RemoteSearchQueryArtistInfo) *NullableRemoteSearchQueryArtistInfo {
	return &NullableRemoteSearchQueryArtistInfo{value: val, isSet: true}
}

func (v NullableRemoteSearchQueryArtistInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSearchQueryArtistInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
