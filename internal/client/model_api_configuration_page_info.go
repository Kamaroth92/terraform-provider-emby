...
// checks if the ApiConfigurationPageInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiConfigurationPageInfo{}

// ApiConfigurationPageInfo struct for ApiConfigurationPageInfo
...
func (o *ApiConfigurationPageInfo) GetConfigurationPageType() PluginsConfigurationPageType {
	if o == nil || IsNil(o.ConfigurationPageType) {
		var ret PluginsConfigurationPageType
		return ret
	}
...
// SetConfigurationPageType gets a reference to the given PluginsConfigurationPageType and assigns it to the ConfigurationPageType field.
...
// SetPlugin gets a reference to the given CommonPluginsIPlugin and assigns it to the Plugin field.
...
func (o ApiConfigurationPageInfo) MarshalJSON() ([]byte, error) {
...
func (o ApiConfigurationPageInfo) ToMap() (map[string]interface{}, error) {
...
type NullableApiConfigurationPageInfo struct {
	value *ApiConfigurationPageInfo
	isSet bool
}

func (v NullableApiConfigurationPageInfo) Get() *ApiConfigurationPageInfo {
	return v.value
}

func (v *NullableApiConfigurationPageInfo) Set(val *ApiConfigurationPageInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableApiConfigurationPageInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableApiConfigurationPageInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiConfigurationPageInfo(val *ApiConfigurationPageInfo) *NullableApiConfigurationPageInfo {
	return &NullableApiConfigurationPageInfo{value: val, isSet: true}
}

func (v NullableApiConfigurationPageInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiConfigurationPageInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
