...
func Test_embyclient_ImageServiceAPIService(t *testing.T) {
	...
	t.Run("Test ImageServiceAPIService DeleteItemsByIdImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.DeleteItemsByIdImagesByTypeByIndex(context.Background(), id, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService DeleteUsersByIdImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.DeleteUsersByIdImagesByTypeByIndex(context.Background(), id, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService GetArtistsByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.GetArtistsByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService GetGamegenresByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.GetGamegenresByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService GetGenresByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.GetGenresByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService GetItemsByIdImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.GetItemsByIdImagesByTypeByIndex(context.Background(), id, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService GetItemsByIdImagesByTypeByIndexByTagByFormatByMaxwidthByMaxheightByPercentplayedByUnplayedcount", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.GetItemsByIdImagesByTypeByIndexByTagByFormatByMaxwidthByMaxheightByPercentplayedByUnplayedcount(context.Background(), percentPlayed, unPlayedCount, id, maxWidth, maxHeight, tag, format, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService GetMusicgenresByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.GetMusicgenresByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService GetPersonsByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.GetPersonsByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService GetStudiosByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.GetStudiosByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService GetUsersByIdImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.GetUsersByIdImagesByTypeByIndex(context.Background(), id, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService HeadArtistsByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.HeadArtistsByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService HeadGamegenresByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.HeadGamegenresByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService HeadGenresByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.HeadGenresByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService HeadItemsByIdImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.HeadItemsByIdImagesByTypeByIndex(context.Background(), id, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService HeadItemsByIdImagesByTypeByIndexByTagByFormatByMaxwidthByMaxheightByPercentplayedByUnplayedcount", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.HeadItemsByIdImagesByTypeByIndexByTagByFormatByMaxwidthByMaxheightByPercentplayedByUnplayedcount(context.Background(), percentPlayed, unPlayedCount, id, maxWidth, maxHeight, tag, format, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService HeadMusicgenresByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.HeadMusicgenresByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService HeadPersonsByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.HeadPersonsByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService HeadStudiosByNameImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.HeadStudiosByNameImagesByTypeByIndex(context.Background(), name, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService HeadUsersByIdImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.HeadUsersByIdImagesByTypeByIndex(context.Background(), id, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService PostItemsByIdImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.PostItemsByIdImagesByTypeByIndex(context.Background(), id, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService PostItemsByIdImagesByTypeByIndexDelete", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.PostItemsByIdImagesByTypeByIndexDelete(context.Background(), id, index, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService PostUsersByIdImagesByTypeByIndex", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.PostUsersByIdImagesByTypeByIndex(context.Background(), id, type_).Execute()
	...
	t.Run("Test ImageServiceAPIService PostUsersByIdImagesByTypeByIndexDelete", func(t *testing.T) {
		...
		httpRes, err := apiClient.ImageServiceAPI.PostUsersByIdImagesByTypeByIndexDelete(context.Background(), id, index, type_).Execute()
