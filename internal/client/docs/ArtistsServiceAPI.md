...
func main() {
	...
	// response from `GetArtists`: QueryResultBaseItemDto
...
func main() {
	...
	// response from `GetArtistsAlbumartists`: QueryResultBaseItemDto
...
> BaseItemDto GetArtistsByName(ctx, name).UserId(userId).Execute()
...
func main() {
	...
	// response from `GetArtistsByName`: BaseItemDto
